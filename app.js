...
var UIController = (function(){
    ...
    var DOMstrings = {
        ...
        container: '.container',
        deleteItemClass: 'ion-ios-close-outline',
        expansesPercentage: '.item__percentage',
        dateLabel: '.budget__title--month'
    };
    
    var formatNumber = function(num, type){
        var num, splits, int, dec, str1, str2;
            ...
            for(var id=int.length - 1; id>=0;){

                if(id >= 3){
                    id -= 3;
                    str1 = int.substring(0,id+1);
                    str2 = int.substring(id+1, int.length);
                    int = str1 + ',' + str2;
                }
                else break;
            }
    ...
    return {            
        ...
        displayBudget: function(obj){
            ...
            document.querySelector(DOMstrings.expansesLabel).textContent = formatNumber(obj.totalExpanse, 'exp');
        ...
        displayPercentage: function(percentages){
            ...
            var fields = document.querySelectorAll(DOMstrings.expansesPercentage);
        ...
        displayMonth : function(){
            ...
            var date, months, month, year, now;
...
var controller = (function(budgetCtrl, UICrtl){
    ...
    var setupEventListeners = function(){
        ...
        document.querySelector(DOM.inputType).addEventListener('change', UICrtl.changeType);
    };
    ...
    var ctrlDeleteItem = function(event){
        ...
        var itemID, targetClass, splitID;
        
        targetClass = event.target.className;
        itemID = event.target.parentNode.parentNode.parentNode.parentNode.id;
        
        if(targetClass  == DOM.deleteItemClass){
            //inc-1 or exp-2
